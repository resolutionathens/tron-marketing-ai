...
- Good final pass before the repo-local `news-item` / `guide-item` skills (available after their
  marketing-pages worktree is added to the session) or `tron:case-study` / `tron:press-release`
  open their PR.
