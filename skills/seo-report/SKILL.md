...
model: sonnet
effort: medium
description: "Work with the Facilitron Search Console (GSC) report — generated by the tron-search-console 'GSC Analyzer' at seo.facilitron.work — to produce a shareable SEO summary, a leadership translation, slide inputs, and follow-up tasks. Use when SEO wants the monthly report or to act on GSC data: 'build the monthly SEO report', 'summarize the search console report', 'what changed in search last month'. Points non-technical users to the hosted app and engineers to the CLI, then helps interpret and repackage the markdown. Optional GA4 context via the analytics MCP. Git-free."
allowed-tools:
  - Bash
  - Read
  - Write
